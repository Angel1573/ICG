...
namespace project
{
    public partial class Hoofdscherm : Form
    {
        ...
        private void AlgemeenOverzicht()
        {
            ...
            string Query = ("SELECT Inschrijving.StartDatum as Startdatum, Inschrijving.Einddatum, Inschrijving.Jaar as [Stage jaar], Student.StudentNr as Studentnummer, Student.Voornaam as [Voornaam student], Student.AchterNaam as [Achternaam student], Instelling.InstellingNaam as Instellingnaam, Instelling.AfdelingNaam as Afdelingnaam, Inschrijving.Differentiatie, Docent.Voornaam as [Voornaam docent], Docent.Achternaam as [Achternaam docent] FROM Student, Inschrijving, Instelling, Docent WHERE Inschrijving.StudentNr = Student.StudentNr And Inschrijving.DocentNr = Docent.DocentNr AND Inschrijving.InstellingNr = Instelling.InstellingNr And Student.Jaar In (\"" + Knopjr1 + "\", \"" + Knopjr2 + "\", \"" + Knopjr3 + "\", \"" + Knopjr4 + "\", \"" + JaarDeel + "\") AND now() between [Inschrijving.StartDatum] and [Inschrijving.EindDatum] ORDER BY Inschrijving.StartDatum;");
